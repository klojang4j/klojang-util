...
import static org.klojang.util.path.ErrorCode.EMPTY_SEGMENT;
import static org.klojang.util.path.ErrorCode.EXCEPTION;
import static org.klojang.util.path.ErrorCode.INDEX_EXPECTED;
import static org.klojang.util.path.ErrorCode.INDEX_OUT_OF_BOUNDS;
import static org.klojang.util.path.ErrorCode.KEY_DESERIALIZATION_FAILED;
import static org.klojang.util.path.ErrorCode.NOT_MODIFIABLE;
import static org.klojang.util.path.ErrorCode.NO_SUCH_KEY;
import static org.klojang.util.path.ErrorCode.NO_SUCH_PROPERTY;
import static org.klojang.util.path.ErrorCode.TERMINAL_VALUE;
import static org.klojang.util.path.ErrorCode.TYPE_MISMATCH;
